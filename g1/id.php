...
function validateForm() {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <a href= "http://localhost/g1/index.php"> <input class="btn btn-primary" type="submit" name="Logout" value="Logout"></a>
        ...
        <br> <br>
    <div class="container">
        <form class="needs-validation" name="myform"  method="post"   action="teacher_id.php" novalidate >
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationTooltip01">Teacher ID</label>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip04" placeholder="10" name="incharge" >
      <div class="invalid-tooltip">
        please mention it
      </div>
    </div>
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip05" placeholder="A"  name="section">
      <div class="invalid-tooltip">
        Please mention it.
      </div>
    </div>
