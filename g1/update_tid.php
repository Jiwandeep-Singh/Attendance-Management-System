                       ...
                       if (isset($_POST['update']))
                      {
                        ...
                        $result1 = mysqli_query($link, $sql);
                           ...
                           }elseif($count>0)
                           {
                                ...
                                if( $password != '')   
                                {
                                    $sql="UPDATE teacher_login SET password ='$password' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
                               ...
                               if( $name != '')   
                                {
                                    $sql="UPDATE teacher_login SET  name = '$name' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
                               ...
                               if( $phone_no != '')   
                                {
                                    $sql="UPDATE teacher_login SET  phone_no ='$phone_no' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
