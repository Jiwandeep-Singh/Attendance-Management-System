   ...
   <a href= "http://localhost/g1/index.php"> <input class="btn btn-primary" type="submit" name="Logout" value="Logout"></a>
       ...
       <?php echo "<h6> &nbsp Class  : $i $s </h6> <br>"; ?>
            ...
            <table class="table table-striped">
                ...
                $sql = "select *from `student_login` where `class`= '$cl'  and `section`= '$s' " ;  
                ...
                <td>Present<input type="radio" name="attendance[<?php echo $data["id"] ?>]" value="present">&nbsp;  Absent<input   type="radio" name="attendance[<?php echo $data["id"] ?>]" value="absent" checked="checked"> </td>
                </tr>
                <?php 
                     }
                ?>
      ...
      <head>  <?php
          $d=date('Ymd');
          $sql = "select *from $table where date=$d " ;  
                $result1 = mysqli_query($link, $sql);
