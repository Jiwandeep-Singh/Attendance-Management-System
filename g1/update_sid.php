  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <a href= "http://localhost/g1/index.php"> <input class="btn btn-primary" type="submit" name="Logout" value="Logout"></a>
        ...
        ?>
            ...
            <!-- Content here -->
            <form method="POST" >
                <input type="text" name="id1" placeholder="student_id">
               ...
               <td> <?php echo $data["class"]; ?></td>
                ...
                ?>
                      ...
                      <br>
                         ...
                         <form method="POST" >
                <input type="text" name="id2" placeholder="student_id">
                       ...
                       if (isset($_POST['update']))
                      {
                        ...
                        $result1 = mysqli_query($link, $sql);
                           ...
                           }elseif($count>0)
                           {
                                ...
                                if( $password != '')   
                                {
                                    $sql="UPDATE student_login SET password ='$password' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
                               ...
                               if( $name != '')   
                                {
                                    $sql="UPDATE student_login SET  name = '$name' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
                               ...
                               if( $phone_no != '')   
                                {
                                    $sql="UPDATE student_login SET  phone_no ='$phone_no' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
                               
                                }
                                if( $class != '')   
                                {
                                    $sql="UPDATE student_login SET  class ='$class' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
                                ...
                                if( $section != '')   
                                {
                                    $sql="UPDATE student_login SET  section ='$section' WHERE id ='$id2'";
                               $result1 = mysqli_query($link, $sql);
