...
function validateForm() {
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <a href= "http://localhost/g1/index.php"> <input class="btn btn-primary" type="submit" name="Logout" value="Logout"></a>
        ...
        <br> <br>
    <div class="container">
        <form class="needs-validation" name="myform" action="student_id.php" method="post" novalidate >
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label for="validationTooltip01">Student ID</label>
      <input type="text" class="form-control" id="validationTooltip01" name="SID" placeholder="101"  required>
    ...
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip02" name="password" placeholder="abc"  required>
      <div class="valid-tooltip">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip03" name="number" placeholder="98XXXXXXXXX" required>
      <div class="invalid-tooltip">
        Please provide a valid phone number.
      </div>
    </div>
    <div class="col-md-4 mb-3">
      <label for="validationTooltip04">Class</label>
      <input type="text" class="form-control" id="validationTooltip04" name="clas" placeholder="10" >
      <div class="invalid-tooltip">
        please mention it
      </div>
    </div>
    <div class="col-md-4 mb-3">
      ...
      <input type="text" class="form-control" id="validationTooltip05" name="section" placeholder="A" >
      <div class="invalid-tooltip">
        Please mention it.
      </div>
    </div>
