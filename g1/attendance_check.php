 ...
 ?>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
   ...
   <a href= "http://localhost/g1/index.php"> <input class="btn btn-primary" type="submit" name="Logout" value="Logout"></a>
            ...
            <!-- Content here -->
            <form method="POST" >
             <input type="text" name="id1" placeholder="student id"> 
                <input type="text" name="clas" placeholder="Class">
                      ...
                      { 
                        ...
                        }else
                        {
                          ...
                          }else
                          {
                           ...
                           echo "<br> <h6> &nbsp Class  : $i $s </h6> <br>"; 
  ...
  <div class=" <?php
              ...
              ?>"
       role="progressbar" style="width: <?php echo(round($per)); ?>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"> <?php 
                          $per=round($per,2);
                              echo $per; ?>%</div>
          </div> </td>
    </tr>
